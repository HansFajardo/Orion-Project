...
function CompanyMessageSent() {
    return (
        <div className='my-2 me-5 ms-auto'>
            <div className='rounded-3 d-inline-block bg-primary text-white py-2 px-3' style={{ maxWidth: "30vw" }}>
...
export default CompanyMessageSent;