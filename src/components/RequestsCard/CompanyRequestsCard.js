...
export default function CompanyRequestsCard({ status }) {
    ...
    >
      <div className="row border-bottom p-3 fw-semibold align-items-center">
        ...
        <div className="col-lg-4 d-flex justify-content-end gap-4">
          <button className={`btn rounded-5 px-4 d-flex align-items-center text-white bg-success`}>
            Accept
          </button>
          <button className={`btn rounded-5 px-4 d-flex align-items-center text-white bg-danger`}>
            Reject
          </button>
          <Button
