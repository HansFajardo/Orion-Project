...
import CompanyPendingCompanyTransaction from "./PendingCompanyTransaction/CompanyPendingCompanyTransaction";
import CompanyCompletedCompanyTransaction from "./CompletedCompanyTransaction/CompanyCompletedCompanyTransaction";
              ...
              <Container fluid>
                <Row>
                  ...
                  {Array(5).fill(null).map((element) => (
                    <CompanyPendingCompanyTransaction clientName={'Hans Amponin'} amount={'25,000'} dueDate={'October 23,2023'} />
                  ))}
                </Row>
              </Container>
            )}
            ...
            {activeCategory === "Completed Transactions" && (
              <Container fluid>
                <Row>
                  ...
                  {Array(5).fill(null).map((element) => (
                    <CompanyCompletedCompanyTransaction clientName={'Hans Amponin'} amount={'25,000'} dueDate={'October 23,2023'} />
                  ))}
                </Row>
              </Container>
            )}
